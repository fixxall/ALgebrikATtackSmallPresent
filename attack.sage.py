...
_sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_6 = Integer(6); _sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_5 = Integer(5); _sage_const_7 = Integer(7); _sage_const_256 = Integer(256); _sage_const_8 = Integer(8)
import os
import string
...
loop = _sage_const_256 
if(mode==_sage_const_0 ): loop = _sage_const_1 
for num_byte_index in range(loop):
    ...
    num_byte += "/"
    if(mode==_sage_const_1 ): PLaintext = [int(i) for i in bin(num_byte_index)[_sage_const_2 :].zfill(_sage_const_8 )]
